 ...
 */
@WebServlet(name = "registroTabla2", urlPatterns = {"/registroTabla2"})
public class registroTabla2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            accionesBD1.registroTabla1(nombre, correo, contraseña, fechaNacimiento,"administrador");
            accionesBD2.registroTabla2(empleado);
            
            factoria = factoria.getFactoria();
            usuario admin = factoria.getUsuario("admin");
            admin.setNombre(nombre);
            admin.setCorreo(correo);
            admin.setContraseña(contraseña);
            admin.setFechaNacimiento(fechaNacimiento);
            admin.setTipoUsuario("administrador");
            admin.setNum_empleado(empleado);

            session.setAttribute("admin", admin);

            response.sendRedirect("loginTabla2.jsp");
        }
    }
